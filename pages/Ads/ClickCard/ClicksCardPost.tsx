  ...
  return (
    <div className='border border-gray-500 rounded-xl   mt-4'>
      ...
      <div className='px-8 py-2  flex flex-col gap-8'>
        ...
        <div className=''><div className='flex gap-4'><p className='text-gray-500 border-b border-dashed w-fit border-gray-500'>Total Clicks</p> <button className='bg-blue-600 rounded-lg text-white font-semibold w-fit h-fit p-1'>Key Result</button></div><span className='text-xl font-semibold'>900</span></div>
